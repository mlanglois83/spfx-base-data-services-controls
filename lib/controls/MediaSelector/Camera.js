...
export var Camera = function (props) {
    ...
    var photoInput;
    var fileInput;
    var cssClasses = props.cssClasses, mediaTypes = props.mediaTypes, icons = props.icons;
                    ...
                    React.createElement("div", { className: css(styles.cameraRow, cssClasses && cssClasses.cameraRow ? cssClasses.cameraRow : null) },
                        ...
                        React.createElement("div", { className: css(styles.cameraActionsRow, cssClasses && cssClasses.cameraActionsRow ? cssClasses.cameraActionsRow : null) },
                            React.createElement("div", { className: css(styles.cameraActions, cssClasses && cssClasses.cameraActions ? cssClasses.cameraActions : null) },
                                React.createElement(DefaultButton, { className: cssClasses ? cssClasses.cancelButton : undefined, onClick: function () { setRTC(false); }, text: strings.cancelButtonLabel, iconProps: icons && icons.cancel ? { iconName: icons.cancel } : undefined }),
                                mode == CameraMode.Picture &&
                                    React.createElement(PrimaryButton, { className: cssClasses ? cssClasses.primaryButton : undefined, text: strings.takePicture, onClick: capture, iconProps: icons && icons.picture ? { iconName: icons.picture } : undefined }),
                                mode == CameraMode.Video &&
                                    React.createElement(PrimaryButton, { className: cssClasses ? cssClasses.primaryButton : undefined, text: !videoRecorder ? strings.startVideo : strings.stopVideo, onClick: capture, iconProps: !videoRecorder && icons && icons.startVideo ? { iconName: icons.startVideo } : (videoRecorder && icons && icons.stopVideo ? { iconName: icons.stopVideo } : undefined) }),
                                devices.length > 1 && React.createElement(React.Fragment, null,
                                    React.createElement(PrimaryButton, { className: cssClasses ? cssClasses.primaryButton : undefined, text: "Switch camera", onClick: function () {
